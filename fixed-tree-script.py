...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        focus_folders = [
            ...
            os.path.join(root_directory, "config"),
            os.path.join(root_directory, "utils"),
            os.path.join(root_directory, "public")
        ]
        ...
        print_tree(
            ...
            exclude_patterns=[".git", "__pycache__", "venv", "env", "node_modules", ".next", ".vercel"]
        )
    else:
        main()
